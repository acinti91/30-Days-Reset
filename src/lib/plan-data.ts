  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        coachIntro: "**Two weeks complete** — you're about to cross the halfway mark.\n\nToday's screen time check is important: compare the number to your Day 5 baseline and let the data speak. Most people see a **30-50% reduction** by this point. That's not willpower — that's your brain genuinely wanting less stimulation because it's starting to find satisfaction elsewhere.\n\nThe analog activity today should be something **immersive** — a hike, a museum, a library afternoon, a workshop. Give yourself permission to lose track of time in something real.\n\nTomorrow begins the third week, which is **the hardest stretch** of the reset. Motivation naturally dips around the midpoint. Today, refill your reserves.",
      },
    ],
  },
  {
